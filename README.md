About enmapbox-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/enmapbox-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/enmapbox-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/enmapbox-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `enmapbox` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search enmapbox --channel conda-forge

# List packages depending on `enmapbox`:
mamba repoquery whoneeds enmapbox --channel conda-forge
...
Updating enmapbox-feedstock
===========================

If you would like to improve the enmapbox recipe or build a new
...
Note that all branches in the conda-forge/enmapbox-feedstock are
